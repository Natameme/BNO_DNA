...
parser.add_argument('-P', '--port', action='store', help="Port for Troop server (default 57990)")
...
if args.cli:
    ...
    if 'port' not in options:
        ...
        options['port'] = readin("Port Number", default="57990")
