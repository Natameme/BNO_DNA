...
"""
    ...
    The Troop Server runs on the local machine by default on port 57990.
...
if __name__ == '__main__':
    ...
    parser.add_argument("-p", "--port", help="Specify a port to use (default is 57990, auto-increments when multiple instances are running.)", default=57990, type=int)
